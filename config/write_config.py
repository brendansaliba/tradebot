...
config.set('main', 'JSON_PATH', r'/Users/brendansaliba/Projects/Projects Data Dump/TradeBotDump/token.json')
config.set('main', 'ACCOUNT_NUMBER', '71611620')
config.set('main', 'CREDENTIALS_PATH', r'/Users/brendansaliba/Projects/TradeBot/tradebot_prototype/docs/notes/refreshtoken_Jun6_2021.txt')
